...
public static void main(String[] args) throws SQLException {
    ...
    String strSqlCriarBancoDeDados = "create table `db_teste`.`tbl_teste` (`id` int not null auto_increment, `nome` varchar(255) not null, `senha` varchar(255) not null, primary key (`id`));";
